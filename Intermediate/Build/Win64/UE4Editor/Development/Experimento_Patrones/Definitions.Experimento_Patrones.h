#undef EXPERIMENTO_PATRONES_API
...
#define UE_PROJECT_NAME Experimento_Patrones
#define UE_TARGET_NAME Experimento_PatronesEditor
#define UE_MODULE_NAME "Experimento_Patrones"
...
#define EXPERIMENTO_PATRONES_API DLLEXPORT
